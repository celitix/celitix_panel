  ...
  return (
    <div className="md:p-4 p-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 2xl:grid-cols-5 items-end gap-0">
      {services.map((s, idx) => {
        ...
        return (
          <StyledWrapper key={s.service_type_id}>
            <div className="parent">
              <div className="card">
                      ...
                      {s.animation ? (
                        <div className="w-full h-auto text-left">
                          <Lottie
                            ...
                            loop
                            autoplay
                            className=" w-8 h-8 md:w-13 md:h-13 opacity-70"
                          />
                        </div>
                      ) : (
                ...
                <div className="content">
                  ...
                  <span className="text">{s.desc}</span>
                </div>
                <div className="bottom">
                  ...
                  <div className="view-more">
                    <button
                      className={`absolute bottom-2 right-2 text-xs  font-semibold px-3 py-1 rounded-full shadow transition
                    ${
                      isActive
                        ? " rounded-2xl shadow-md backdrop-blur-sm text-green-700"
                        : " text-red-700 rounded-2xl shadow-md backdrop-blur-sm"
                    }`}
                    >
...
const StyledWrapper = styled.div`
  ...
  .card {
    ...
    height: 90%;
    border-radius: 50px;
    background: linear-gradient(135deg, #d9eafd 0%, #d9eafd 100%);
  ...
  .logo .circle {
    ...
    top: 0;
    right: 0;
    box-shadow: #d3f1df -10px 10px 20px 0px;
