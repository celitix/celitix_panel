...
export default function ServiceUsageDashboard() {
  ...
  return (
    ...
    >
      <div className="flex md:flex-row flex-col gap-3 rounded-2xl bg-gradient-to-tr from-blue-50 via-white to-blue-100 border-2 border-dashed border-blue-200 p-2 md:h-auto ">
        {/* Sidebar */}
        ...
        ${filter === item ? "translate-y-0" : "translate-y-full"}`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-2 w-full">
