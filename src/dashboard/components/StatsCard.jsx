...
export default function StatsCard({
  ...
  return (
    <div className="flex flex-wrap items-center justify-center md:items-end md:justify-start  gap-4 md:p-4 p-0  ">
      {quickStats.map((stat, i) => (
        ...
        >
          ...
          >
            ...
            >
              <div className="relative flex flex-col justify-between p-4 md:p-6 w-70 h-28 sm:h-38 sm:w-80 rounded-2xl shadow-sm backdrop-blur-sm">
