...
const Dashboard = () => {
  ...
  const rings = useMemo(() => {
    if (window.innerWidth < 640) return [50, 90, 130];
    if (window.innerWidth < 1024) return [70, 120, 170];
    return [100, 160, 220];
  }, []);

  const ringsicons = [
    { src: slack, ring: 1, angle: 0 },
    { src: freshdesk, ring: 1, angle: 90 },
    { src: shopify, ring: 1, angle: 170 },
    { src: instagram, ring: 1, angle: 250 },
    { src: wordpress, ring: 2, angle: 50 },
    { src: telegram, ring: 2, angle: 120 },
    { src: zapier, ring: 2, angle: 220 },
    { src: woocommerce, ring: 2, angle: 300 },
    { src: zohoicon, ring: 0, angle: 180 },
  ...
  return (
    <div className="bg-white text-gray-900 rounded-4xl md:p-4 p-2 space-y-5 overflow-hidden">
      <div className="relative w-full overflow-hidden bg-linear-to-t from-indigo-100 via-purple-50 to-blue-100 text-gray-800 rounded-4xl p-5 md:p-0 shadow-md">
        <div className="flex flex-col md:flex-row justify-center items-center  md:justify-between mt-5 gap-4 px-4 ">
          {/* Brand Name */}
          ...
          <div className="flex flex-row mb-5 gap-4 ">
            ...
            <div className="flex justify-center items-center md:gap-3 gap-4 z-0 ">
              {/* Profile  */}
      ...
      {/* service cards */}
      <div className="relative overflow-y-scroll xl:overflow-hidden bg-linear-to-t from-indigo-100 via-purple-50 to-blue-100 border border-gray-200 rounded-4xl shadow-md backdrop-blur-2xl text-gray-800">
      ...
      {/* intigration section */}
      <div className="space-y-4 grid md:grid-cols-2 grid-cols-1 gap-4 items-stretch">
        {/* Left Wallet Chart */}
        ...
        {/* Right SVG  Circles */}
        <div className="flex-1 relative bg-linear-to-t from-indigo-100 via-purple-50 to-blue-100 rounded-4xl shadow-lg md:p-4 p-6 w-full h-120 md:h-auto">
          <div className="">
          ...
          <div className="flex items-center justify-center">
            <div
              ref={containerRef}
              className="relative w-[180px] mt-18 md:mt-0 md:w-[500px] aspect-square"
            >
              <div
                  ...
                  return (
                    ...
                    >
                      <img
                        src={icon.src}
                        alt="icon"
                        className="md:w-12 md:h-12 w-7 h-7 rounded-full bg-white shadow-md object-contain p-1"
                      />
                    </div>
                  );
                })}
              ...
              {/* Centered favicon */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[50px] h-[50px] sm:w-[60px] sm:h-[60px]">
                <img
                  src={Celitixfavicon}
      ...
      <div className="bg-white shadow-lg border p-4 flex flex-col justify-center items-center gap-6 w-full mt-25 rounded-3xl">
        <div className="relative w-full flex justify-center">
          {/* Left Scroll Button */}
          <button
            onClick={() => scroll("left")}
            className="absolute md:left-2 -left-3 top-1/2 md:-translate-y-1/2 -translate-y-full bg-white shadow-md rounded-full p-2 z-10 xl:hidden"
          >
          ...
          >
            {servicesDailyUsage.map((s, idx) => (
              <div
                ...
                className={`flex items-center gap-2 rounded-full px-3 py-2 cursor-pointer transition text-sm font-medium text-nowrap
          ...
          <button
            ...
            className="absolute md:right-2 top-1/2 -right-3 md:-translate-y-1/2 -translate-y-full  bg-white shadow-md rounded-full p-2 z-10 xl:hidden"
          >
        ...
        <div className="mb-8 w-full p-4 mt-4">
          {/* Header */}
          ...
          {/* Date Range */}
          <div className="flex flex-row items-center gap-4 mb-6 text-sm text-gray-700">
            <div>
              <span className="font-medium">From:</span>
              {formatDate(startDate)}
            </div>
            <div>
              <span className="font-medium">To:</span> {formatDate(endDate)}
            </div>
          </div>
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 mb-3">
          <div className="relative bg-white border-t border-purple-200 p-6 md:py-8 px-4 rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 flex items-center justify-between">
