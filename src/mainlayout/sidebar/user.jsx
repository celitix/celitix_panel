...
export const userItems = [
  ...
  // },
  {
    ...
    links: [
      ...
      { to: "/smscampaigndetailsreport", label: "smsreportsdetails", isHide: true },
    ],
  ...
  },
  {
    ...
    links: [
      ...
      { to: "/wflowsdetailsreport", label: "wflowsdetailsreport", isHide: true },
    ],
    roles: ["ADMIN", "DIRECTUSER"],
  },
  {
  ...
  },
  {
    ...
    links: [
      ...
      { to: "/obdCampaignDetailslog", label: "obdCampaignDetailslog", isHide: true },
  ...
  // },
  {
    ...
    links: [
      ...
      { to: "/addcallback", label: "Add Call Back", isHide: true },
      { to: "/editcallback", label: "Edit Call Back", isHide: true },
      { to: "/createpdfconverter", label: "Create PDF Converter", isHide: true },
    ],
    roles: ["ADMIN"],
  },
];
