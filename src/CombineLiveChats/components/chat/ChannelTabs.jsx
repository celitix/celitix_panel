              ...
              {selectedChannel?.service_type_id === "2" && (
                <div className="flex flex-wrap gap-2">
                  {quickActions
                    ...
                    .map((action, i) => {
                      const isWabaAction =
                        action.label === getSelectedWabaName() && selectedWabaUser;
                      return (
                        <motion.button
                          key={i}
      ...
      {/* <div
        ...
        <ul className="w-40 border border-gray-300 rounded-md text-sm bg-white z-999">
          ...
          {wabaState?.waba?.map((waba) => {
            return (
              <li
                ...
                onClick={() => {
                  ...
                  const wabaName = wabaState?.waba?.find(
                    (w) => w.name === waba.name,
                  )?.name;
            ...
            ${
              wabaState?.selectedWaba === waba.mobileNo
              ...
              <li
                ...
                onClick={(prev) => {
                  setInstagramData((prev) => ({
                    ...
                    selectedOffDetailSrno: acc.instaOffDetailSrNo
                  }));
                  setIsInstagramOpen(false);
                }}
                className={`px-3 py-2 cursor-pointer border-b hover:bg-pink-50 hover:text-pink-600 transition-colors
