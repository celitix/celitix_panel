...
// import { getWabaList } from "@/apis/admin/admin";
...
const ChannelTabs = () => {
  ...
  const { selectedWabaUser, setSelectedWabaUser, wabaUsers, setWabaUsers } =
    useSettings();
  ...
  //         userSrno: -1,
  //       };
  //       const res = await getWabaList(payload);
  ...
  //     const matchedWaba = wabaState?.waba?.find(
    ...
    <div className="flex flex-col gap-1 relative z-10">
            ...
            <motion.div className="px-4 py-2 md:flex w-full gap-3 bg-white shadow rounded-md border border-gray-100 overflow-auto">
                        ...
                        .map((action, i) => {
                          ...
                          ${isWabaAction
                            ...
                            >
                              ...
                              {action.isDropdown && (
                                <FaAngleDoubleDown
                                  className={`text-[10px] transition-transform ${(action.dropdownType === "instagram" &&
                                    isInstagramOpen) ||
              ...
              {selectedChannel?.service_type_id === "12" && (
                <div className="flex flex-wrap gap-2 relative">
                  {quickInstagramActions.filter((action) => {
                    if (user.role === "AGENT") {
                      return (
                        action.label !== "Setting"
                      );
      ...
      {isWhatsappOpen && (
        <motion.div
          ...
          className="absolute top-full left-0 mt-2 w-56 bg-white border border-gray-200 shadow-2xl rounded-xl z-[999999] max-h-50 overflow-scroll"
        >
