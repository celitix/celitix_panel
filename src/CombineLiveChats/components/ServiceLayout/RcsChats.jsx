...
export function RcsChatBot() {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-100 via-white to-blue-50 min-h-[85vh] flex items-center justify-center rounded-3xl">
      <motion.div
      ...
      >
        ...
        <p className="text-xs text-gray-600 mb-4 px-2">
          Automate customer conversations using verified RCS business messaging.
        </p>
        ...
        <div className="space-y-2 mb-4 text-left">
          <Feature
            ...
            title="Verified business sender identity"
          />
          <Feature
            icon={<SmsIcon fontSize="small" />}
            title="Automated replies with rich RCS messages"
          />
          <Feature
            icon={<AccountCircleIcon fontSize="small" />}
            title="Personalized chat bot responses"
          />
          <Feature
            icon={<ShareIcon fontSize="small" />}
            title="Send campaigns, alerts & offers"
          />
        </div>

        {/* CTA */}
        <button
          className="w-full flex items-center justify-center gap-2 bg-blue-600 text-white font-semibold py-2.5 rounded-lg hover:bg-blue-700 transition shadow-md"
        >
        ...
        <p className="text-[10px] text-gray-500 mt-3">
          Requires an RCS-enabled number and business verification.
        </p>
      </motion.div>
    </div>
  );
