...
//   // when pass data in params
//   // Add wabaId and phoneNumberId as optional parameters
//   // async function onboardUser(accessToken, wabaId = null, phoneNumberId = null) {
//   //   // Build the URL dynamically based on whether IDs exist
//   //   let url = `${API_BASE_URL}/whatsapp/wabaOnboardProcess?code=${accessToken}`;

//   //   if (wabaId) url += `&wabaAccountId=${wabaId}`;
...
//   // https://business.facebook.com/messaging/whatsapp/onboard/?app_id=819027950096451&config_id=827520649332611&extras=%7B%22featureType%22%3A%22whatsapp_business_app_onboarding%22%2C%22sessionInfoVersion%22%3A%223%22%2C%22version%22%3A%22v3%22%2C%22features%22%3A[%7B%22name%22%3A%22marketing_messages_lite%22%7D%2C%7B%22name%22%3A%22app_only_install%22%7D]%7D
...
//   // const handleFacebookBusinessAppOnboardingNEW = async (wabaId, phoneId) => {
...
//   //   // console.log("handleFacebookBusinessAppOnboarding", wabaId, phoneId);

//   //   // // const finalWabaId = passedWabaId || fbData.waba_id;
//   //   // // const finalPhoneId = passedPhoneId || fbData.phone_number_id;
...
//   //   //       // console.log('Access Token:', accessToken);
//   //   //       // onboardUser(accessToken);
//   //   //       // onboardUserNewUser(accessToken, fbData.waba_id, fbData.phone_number_id);
//   //   //       // onboardUserNewUser(accessToken, finalWabaId, finalPhoneId);
//   //   //       // await onboardUserNewUser(accessToken, wabaId, phoneId);
//   //   //       setFbData({
//   //   //         waba_id: wabaId,
...
//   //   // );
//   // };
//   //   const handleFacebookBusinessAppOnboarding = () => {
//   //     if (!window.FB) {
//   //       toast.error("Facebook SDK not loaded");
//   //       return;
//   //     }
...
//     setDisplayName(
//       wabaDetails?.businessName || row?.name || ""
//     );
//   };
...
//     if (displayName?.trim() && displayName !== selectedWaba?.name) {
//       const res = await updateWabaDisplayName({
//         wabaSrno: selectedWaba?.wabaSrno,
...
//               className="no-xs"
//               onClick={() => handleSync(params.row)}
//               disabled={loadingRow === params.row.wabaSrno} // disable while loading
//             >
...
//   //       if (data.event === 'FINISH') {
//   //         const { phone_number_id, waba_id } = data.data;
//   //         setFbData({ waba_id, phone_number_id });
//   //         handleFacebookBusinessAppOnboarding(waba_id, phone_number_id);
...
//   //   console.log("Clicked on launch whatsapp signup")
...
//   // https://www.facebook.com/v20.0/dialog/oauth?app_id=819027950096451&cbt=1768809064442&channel_url=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Dfc56f9a0c15c6e471%26domain%3Dlocalhost%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Flocalhost%253A5173%252Ff6f052efb4712e277%26relation%3Dopener&client_id=819027950096451&config_id=827520649332611&display=popup&domain=localhost&e2e=%7B%7D&extras=%7B%22setup%22%3A%7B%7D%7D&fallback_redirect_uri=https%3A%2F%2Flocalhost%3A5173%2Fwmanagewaba&locale=en_US&logger_id=fefe359b2b75f7c3f&origin=1&override_default_response_type=true&redirect_uri=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df07b2600c0bacf35c%26domain%3Dlocalhost%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Flocalhost%253A5173%252Ff6f052efb4712e277%26relation%3Dopener%26frame%3Dfe9ab384ee7812ecc&response_type=code&sdk=joey&version=v20.0
