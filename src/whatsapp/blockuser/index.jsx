...
export const BlockUser = ({ selectedWabaUser, selectedWabaUserName }) => {
    ...
    const fetchBlockedUsers = async () => {
        try {
            const res = await getblockUser(selectedWabaUser?.mobileNo);
    ...
    const handleUnblock = async () => {
        try {
            ...
            const res = await deleteblockUser(selectedWabaUser?.mobileNo, payload);
            if (res?.block_users?.removed_users?.length === 0) {
    ...
    return (
        <>
            <div className="h-full bg-gradient-to-br from-green-50 via-white to-green-100 rounded-xl py-4 px-2 shadow-lg">
                <div className="">
                    <div className="text-center mb-4 py-3">
                        <h1 className="text-2xl font-bold text-[#128c7e] mb-2">
                            Blocked WhatsApp Users - {selectedWabaUserName?.name}
                        </h1>
                            ...
                            <div className="flex flex-col items-center justify-center h-full  ">
                                <AnimatePresence>
                                    <motion.div
                                        ...
                                        className="border-3 p-8 border-[#128c7e] rounded-2xl border-dashed shadow-2xl"
                                    >
                                        {/* <motion.div
                      animate={{ y: [0, -10, 0] }}
                    ...
                    >
                      ...
                      />
                                        ...
                                        <p className="text-gray-500 text-center max-w-xs text-sm">
                                            Choose a WABA from the dropdown to view blocked
                                            users.
                                        </p>
                                    </motion.div>
                                </AnimatePresence>
                            ...
                            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 py-16">
                                {skeletonCards}
                            </div>
                            ...
                            <div className="flex flex-col items-center justify-center h-full">
                                <AnimatePresence>
                                    <motion.div
                                        ...
                                        exit={{ opacity: 0, y: 30 }}
                                        transition={{ duration: 0.3 }}
                                        className="flex flex-col items-center w-max justify-center border-3 p-8 border-[#128c7e] rounded-2xl border-dashed shadow-2xl"
                                    >
                                        <CgUnblock className="text-6xl text-[#128c7e] animate-bounce mb-0" />
                                        <h3 className="text-lg font-semibold text-[#128c7e]">
                                            No Blocked Users
                                        </h3>
                                                ...
                                                >
                                                    <div className="mb-4">
                                                        ...
                                                        <p className="text-sm text-gray-500">
                                                            Blocked from: {selectedWabaUser?.mobileNo}
                                                        </p>
                                                    </div>
                                                    <button
                                                        onClick={() => {
