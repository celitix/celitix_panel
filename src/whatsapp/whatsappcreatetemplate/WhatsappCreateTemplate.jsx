...
const WhatsappCreateTemplate = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (templateValues?.type && templateValues?.text) {
      btns.push({
        type: templateValues?.type,
        text: templateValues?.text,
      });
    }
    // if (
            ...
            <div className="flex flex-wrap items-end justify-start gap-4 pb-5 align-middle">
              ...
              <div className="w-full sm:w-56">
                <InputField
                  ...
                  name="templateName"
                  label="Template Name"
                  tooltipContent="A unique name for your template. Use only lowercase letters, numbers, or underscores — no spaces or special characters."
                  tooltipPlacement="right"
