...
const VariableManagerUrl = ({
  ...
  useEffect(() => {
    ...
    if (
      allowSingleVariable &&
      [...validVariables, ...newVariables].length > 1
    ) {
      setBtnDisabled(true);
      return;
    }
    ...
    <div className="relative w-full ">
      ...
      <div className="flex items-center justify-end ">
        <button
          ...
          className="bg-[#212529] text-white px-2 py-2 font-normal rounded-md text-sm hover:bg-[#434851] absolute -top-11"
        >
          Add Variable
        </button>
      </div>
...
export default VariableManagerUrl;
