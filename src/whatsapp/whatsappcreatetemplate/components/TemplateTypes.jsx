      ...
      <div className="w-full mb-4">
        ...
        <div className="relative">
          ...
          <textarea
            id="createTemplateFormatTextarea"
            name="createTemplateFormatTextarea"
            className="w-full h-60 p-2 pr-10 pb-24 bg-white border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 focus:outline-none sm:text-sm"
            value={templateFormat}
            onChange={(e) => setTemplateFormat(e.target.value)}
            maxLength={1024}
            placeholder="Enter template format"
