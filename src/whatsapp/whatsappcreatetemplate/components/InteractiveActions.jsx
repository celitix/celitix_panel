      ...
      `}
                >
                  <input
                    ...
                    name="templateType"
                    value={option}
                    checked={templateValues.type === option}
                    onChange={() =>
                      setTemplateValues({ type: option, text: "" })
                    }
                    className="hidden"
                  />

                  <AppsIcon className="w-5 h-5" />
                  {option === "CATALOG" ? "Catalog" : option}
                </label>
              ))}
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 mt-4">
            {templateValues.type && (
              <InputField
                ...
                value={templateValues.text}
                placeholder={`Enter ${templateValues.type} `}
                onChange={(e) =>
