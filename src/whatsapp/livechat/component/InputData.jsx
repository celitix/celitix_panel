      ...
      <div className="flex flex-col gap-2">
        <div className="relative">
          ...
          <div className="flex items-center justify-between gap-3">
            <div
              id="input"
              className="flex items-center justify-center w-full px-3 py-2 rounded-full border border-[#075e54] focus-within:ring-1 focus-within:ring-[#25d366]"
              >
              <input
                type="text"
                name="search"
                    ...
                    <div className="p-3 grid grid-cols-2 gap-2">
                      ...
                      <div className="space-y-2 max-h-[250px] overflow-y-auto border-r-2 border-[#ece5dd] pr-2 scrollbar-hide ">
                        {agentList?.data?.map((item) => (
                          <div
                            key={item.sr_no}
                            className={`flex items-center gap-2 p-1 border-2 hover:bg-[#128c7e] hover:text-white transition-all duration-200 cursor-pointer rounded-md overflow-y-auto  ${
        ...
        >
          ...
          <div className="relative z-10 flex w-full text-sm font-medium">
            <button
              ...
              className={`w-1/2 py-2 rounded-full cursor-pointer transition-all tracking-wider text-sm duration-200 ${
                btnOption === "active"
                  ? "text-white font-semibold"
                  : "text-gray-700"
              }`}
            ...
            <button
              ...
              className={`w-1/2 py-1 rounded-full cursor-pointer transition-all tracking-wider text-sm duration-200 ${
                btnOption === "close"
                  ? "text-white font-semibold"
                  : "text-gray-700"
              }`}
