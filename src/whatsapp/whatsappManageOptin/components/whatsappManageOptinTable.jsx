...
const WhatsappManageOptinTable = ({ id, name, handleView, handleDuplicate, handleDelete, setSelectedRows  }) => {
    ...
    const columns = [
        ...
        { field: 'optin', headerName: 'Optin', flex: 1, minWidth: 120 },
        { field: 'incomingblocked', headerName: 'Incoming Blocked ', flex: 1, minWidth: 120 },
        // { field: 'incomingblocked', headerName: 'Template Type', flex: 1, minWidth: 120 },
...
export default WhatsappManageOptinTable;