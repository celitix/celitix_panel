...
const InputVariable = ({ variables = [], onSelect }) => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {showDropdown && (
        <div className="absolute min-w-30 z-99999  lg:left-[35px] md:right-[25px] right-[25px] max-h-47 overflow-auto  bg-white border border-gray-300 rounded-sm shadow-md top-0 ">
