...
const items4 = [
  ...
  },
  {
    ...
    type: "optin",
    label: "Opt in",
    icon: <MoreHorizIcon size="small" fontSize="small" />,
  },
];
...
const Sidebar = ({ onAdd }) => {
  return (
    <Box className="h-[83vh] w-[350px] bg-white py-2 px-2 rounded-2xl sidebar hide-scrollbar shadow-xl overflow-y-scroll">
      <span className="text-sm tracking-wide font-semibold">Basic Text</span>
      <motion.div
      ...
      <span className="text-sm tracking-wide font-semibold">Text Entry</span>
      <motion.div
      ...
      <span className="text-sm tracking-wide font-semibold">Buttons</span>
      <motion.div
      ...
      <span className="text-sm tracking-wide font-semibold">Media Input</span>
      <motion.div
      ...
      <span className="text-sm tracking-wide font-semibold">Conditions</span>
      <motion.div
      ...
      <span className="text-sm tracking-wide font-semibold">Others</span>
      <motion.div
