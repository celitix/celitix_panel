...
const RichTextEditor = ({ onUpdate, selectedItem, onClose, tabs, toggleChecked, setToggleChecked }) => {
  ...
  const handleSave = (logicString = true) => {
    ...
    [&_ul]:list-disc    "
      ...
      <div className="flex justify-center gap-4 mt-4">
        {/* <UniversalButton
          ...
          label="Save"
        /> */}
        <CommonComponent handleSave={(logic) => handleSave(logic)} tabs={tabs} />
      </div>
      <style jsx>{`
        .editor ul li {
          display: list-item;
