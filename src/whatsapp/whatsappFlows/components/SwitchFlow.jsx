...
export default function SwitchFlow({ selectedItem, onSave, tabs, toggleChecked, setToggleChecked }) {
  ...
  const handleSwitchSave = (logicString = true) => {
    const payload = {
      cases,
  ...
  return (
    <div className="p-4 bg-gray-50 text-black font-mono h-auto">
      ...
      <CommonComponent handleSave={handleSwitchSave} tabs={tabs} />
    </div>
  );
}
