...
const EditPanel = ({
  ...
  const getPrettyName = (type) => {
    const count = tabs[activeIndex].payload.filter(item => item.type === type).length;
    // If it's the first one, count is 1, so index is 0 -> "one"
    const word = numberToWord[count] || count;
    return `${type}_${word}`;
  };
  ...
  const handleEmbeddedLinkSave = (logicString = true) => {
    if (!text) {
    ...
    const prettyName = selectedItem.name || getPrettyName("embeddedlink");
    const payload = {
      text: text,
      ...
      name: prettyName,
      visible: toggleChecked ? logicString : true
    };
  ...
  const handleOPTSave = (logicString = true) => {
    if (!optLabel) {
      toast.error("Label is reuired");
      return;
    }

    const prettyName = selectedItem.name || getPrettyName("optin");
    const payload = {
      label: optLabel,
  ...
  const handleImageSave = (logicString = true) => {
    if (!imageFile && !imageSrc) {
    ...
    const prettyName = selectedItem.name || getPrettyName("image");
  ...
  const handleImageCarouselSave = async (logicString = true) => {
    if (imageCarouselImages.some((img) => !img)) {
      toast.error("Please upload all three images");
      return;
    }
    const prettyName = selectedItem.name || getPrettyName("imageCarousel");
    const payload = {
  ...
  const handleIfElseSave = (logicString = true) => {
    if (!selectedCondition) {
      toast.error("Please Enter condition first");
      return;
    }
    const prettyName = selectedItem.name || getPrettyName("ifElse");
    const payload = {
      type: "If",
  ...
  const handleDateSave = (logicString = true) => {
    if (!dateLable) {
    ...
    const prettyName = selectedItem.name || getPrettyName("date");
  ...
  const handleCalendarSave = (logicString = true) => {
    ...
    const prettyName = selectedItem.name || getPrettyName("calendar");
  ...
  const handleDocumentSave = (logicString = true) => {
    if (!description) {
    ...
    const prettyName = selectedItem.name || getPrettyName("document");
  ...
  const handleMediaSave = (logicString = true) => {
    if (!mediaDescription) {
      toast.error("Please Enter Description");
      return;
    }
    ...
    const prettyName = selectedItem.name || getPrettyName("media");
  ...
  const handleSaveRadioButton = (logicString = true) => {
    // 1) Validate label
    ...
    const prettyName = selectedItem.name || getPrettyName("radioButton");
  ...
  const handleCheckBoxSave = (logicString = true) => {
    ...
    const prettyName = selectedItem.name || getPrettyName("checkBox");
  ...
  const handleSaveDropdown = (logicString = true) => {
    ...
    const prettyName = selectedItem.name || getPrettyName("dropDown");
  ...
  const handleChipSelectorSave = (logicString = true) => {
    ...
    const prettyName = selectedItem.name || getPrettyName("chipSelector");
  ...
  const headingSave = (logicString = true) => {
    if (!headingInput) {
      toast.error("Heading Required");
      return;
    }

    const prettyName = selectedItem.name || getPrettyName("heading");
  ...
  const handleSubheadingSave = (logicString = true) => {
    if (!subheadingInput) {
      toast.error("Subheading Required");
      return;
    }

    const prettyName = selectedItem.name || getPrettyName("subheading");
  ...
  const handleTextbodySave = (logicString = true) => {
    if (!textbodyInput.trim()) {
      toast.error("Textbody Required");
      return;
    }

    const prettyName = selectedItem.name || getPrettyName("textbody");
  ...
  const handleTextCaptionSave = (logicString = true) => {
    if (!textcaptionInput.trim()) {
      toast.error("Textcaption Required");
      return;
    }

    const prettyName = selectedItem.name || getPrettyName("textcaption");
  ...
  useEffect(() => {
    if (selectedItem?.type === "textInput") {
      ...
      setSelectedOptionsType(option || { value: "text", label: "Text" });
  ...
  const handleInputSave = (logicString = true) => {
    if (!inputLabel) {
  ...
  const handleTextSave = (logicString = true) => {
    ...
    <Box>
      <AnimatePresence mode="wait">
        ...
        <motion.div
          ...
          className="bg-gray-100 z-10 p-3 absolute right-3 w-140 top-18 border-2 rounded-xl shadow-sm border-gray-200"
        >
          ...
          {selectedItem?.type === "heading" && (
            <div className="mb-2 font-semibold text-lg mt-3 space-y-3 ">
              ...
              <CommonComponent
                handleSave={(logic) => headingSave(logic)}
                tabs={tabs}
          ...
          {selectedItem?.type === "subheading" && (
            <div className="mb-2 font-semibold text-lg mt-3 space-y-3 ">
              ...
              <CommonComponent handleSave={(logic) => handleSubheadingSave(logic)} tabs={tabs} toggleChecked={toggleChecked} setToggleChecked={setToggleChecked} />
            </div>
          )}
          ...
          {selectedItem?.type === "textbody" && (
            <div className="mb-2 font-semibold text-lg mt-3 space-y-3 ">
              ...
              <CommonComponent handleSave={(logic) => handleTextbodySave(logic)} tabs={tabs} toggleChecked={toggleChecked} setToggleChecked={setToggleChecked} />
            </div>
          )}
          ...
          {selectedItem?.type === "textcaption" && (
            <div className="mb-2 font-semibold text-lg mt-3 space-y-3">
              ...
              <CommonComponent handleSave={(logic) => handleTextCaptionSave(logic)} tabs={tabs} toggleChecked={toggleChecked} setToggleChecked={setToggleChecked} />
            </div>
          )}
          ...
          {selectedItem?.type === "textInput" && (
            <div className="mb-2 text-lg space-y-2 mt-3">
              ...
              <CommonComponent
                handleSave={(logic) => handleInputSave(logic)}
                tabs={tabs} toggleChecked={toggleChecked} setToggleChecked={setToggleChecked} />
            </div>
          )}
          ...
          {selectedItem?.type === "textArea" && (
            <div className="mb-2 text-lg space-y-2 mt-3">
              ...
              <CommonComponent handleSave={(logic) => handleTextSave(logic)} tabs={tabs} toggleChecked={toggleChecked} setToggleChecked={setToggleChecked} />
            </div>
          )}
          {/* NEW */}
          ...
          {selectedItem?.type === "richText" && (
            <RichTextEditor
              ...
              tabs={tabs}
              toggleChecked={toggleChecked} setToggleChecked={setToggleChecked}
            />
          )}
          ...
          {selectedItem?.type === "checkBox" && (
            <FormControl fullWidth>
              ...
              <CommonComponent handleSave={(logic) => handleCheckBoxSave(logic)} tabs={tabs} toggleChecked={toggleChecked} setToggleChecked={setToggleChecked} />
            </FormControl>
          )}
          ...
          {selectedItem?.type === "radioButton" && (
            <FormControl fullWidth>
              ...
              <CommonComponent handleSave={(logic) => handleSaveRadioButton(logic)} tabs={tabs} toggleChecked={toggleChecked} setToggleChecked={setToggleChecked} />
            </FormControl>
          )}
          ...
          {selectedItem?.type === "dropDown" && (
            <FormControl fullWidth>
              ...
              <CommonComponent handleSave={(logic) => handleSaveDropdown(logic)} tabs={tabs} toggleChecked={toggleChecked} setToggleChecked={setToggleChecked} />
            </FormControl>
          )}
          ...
          {selectedItem?.type === "chipSelector" && (
            <FormControl fullWidth>
              ...
              <div className="flex justify-center items-center gap-2 mt-3 p-2">
                <UniversalButton
                  label="Add Option"
              ...
              <CommonComponent handleSave={(logic) => handleChipSelectorSave(logic)} tabs={tabs} toggleChecked={toggleChecked} setToggleChecked={setToggleChecked} />
            </FormControl>
          )}
          ...
          {selectedItem?.type === "footerbutton" && (
            <div className="mb-2 text-lg space-y-3 mt-3">
              ...
              {/* <CommonComponent handleSave={(logic) => handleFooterSave(logic)} tabs={tabs} toggleChecked={toggleChecked} setToggleChecked={setToggleChecked} /> */}
            </div>
          )}
          ...
          {selectedItem.type === "embeddedlink" && (
            <div className="mt-5">
              ...
              <CommonComponent handleSave={(logic) => handleEmbeddedLinkSave(logic)} tabs={tabs} toggleChecked={toggleChecked} setToggleChecked={setToggleChecked} />
            </div>
          )}
          ...
          {selectedItem?.type === "optin" && (
            <>
              <div className="space-y-3 mt-3">
                ...
                <CommonComponent handleSave={(logic) => handleOPTSave(logic)} tabs={tabs} toggleChecked={toggleChecked} setToggleChecked={setToggleChecked} />
              </div>
            </>
          )}
          ...
          {selectedItem?.type === "image" && (
            <>
              ...
              /> */}
                ...
                <CommonComponent handleSave={(logic) => handleImageSave(logic)} tabs={tabs} toggleChecked={toggleChecked} setToggleChecked={setToggleChecked} />
              </div>
            </>
          )}
          ...
          {selectedItem?.type === "document" && (
            <>
              ...
              /> */}
                ...
                <CommonComponent handleSave={(logic) => handleDocumentSave(logic)} tabs={tabs} toggleChecked={toggleChecked} setToggleChecked={setToggleChecked} />
              </div>
            </>
          )}
          ...
          {selectedItem?.type === "media" && (
            <>
              <div className="space-y-3 mt-3">
                ...
                <CommonComponent handleSave={(logic) => handleMediaSave(logic)} tabs={tabs} toggleChecked={toggleChecked} setToggleChecked={setToggleChecked} />
              </div>
            </>
          )}
          ...
          {selectedItem?.type === "imageCarousel" && (
            <div className="space-y-3 mt-3">
              ...
              <CommonComponent handleSave={(logic) => handleImageCarouselSave(logic)} tabs={tabs} toggleChecked={toggleChecked} setToggleChecked={setToggleChecked} />
            </div>
          )}
          ...
          {selectedItem?.type === "date" && (
            <div className="space-y-3 mt-3">
              ...
              <CommonComponent handleSave={(logic) => handleDateSave(logic)} tabs={tabs} toggleChecked={toggleChecked} setToggleChecked={setToggleChecked} />
            </div>
          )}
          ...
          {selectedItem?.type === "calendar" && (
            <div className="space-y-3 mt-3">
              ...
              <CommonComponent handleSave={(logic) => handleCalendarSave(logic)} tabs={tabs} toggleChecked={toggleChecked} setToggleChecked={setToggleChecked} />
            </div>
          )}
