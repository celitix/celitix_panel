    ...
    <>
      <div className="h-[78vh]">
        <div className=" flex flex-wrap md:items-end md:justify-between mb-2">
          ...
          <div className="flex flex-wrap items-start gap-4 mt-2 w-full">
        ...
        <div className="flex flex-col md:flex-row gap-3 ">
          <div className="flex flex-col rounded-2xl w-full md:w-70 px-1 border overflow-scroll  scroll-smooth scrollbar-hide">
            <div className="">
              ...
              {categories.map((category) => (
                <div
                  key={category.id}
                  className={`cursor-pointer rounded-lg px-2 py-2.5 hover:shadow-xl transition-shadow duration-300 flex items-center gap-2 ${selectedOptionCategory === category.id
                      ? "bg-white"
                      : "bg-transparent"
                    }`}
                  onClick={() =>
                ...
                >
                  <div className="relative w-5 h-5">
                    ...
                    <span className="absolute inset-0 flex items-center justify-center">
                      <span
                        className={`w-2.5 h-2.5 rounded-full bg-blue-500 transform transition-transform duration-300 ${selectedOptionCategory === category.id
              ...
              <div className="">
                {industries.map((industry) => (
                  <div
                    ...
                    className={`cursor-pointer rounded-lg px-2 py-2.5 hover:shadow-xl transition-shadow duration-300 flex items-center gap-2 ${selectedOptionIndustry?.id === industry.id
                        ? "bg-white"
                        : "bg-transparent"
                      }`}
                  >
                    ...
                    <label
                      ...
                      className={`font-medium text-sm cursor-pointer flex gap-2 items-center ${selectedOptionIndustry?.id === industry.id
                          ? "text-blue-600"
                          : "text-gray-700"
                        }`}
                    >
              ...
              <div className="transition-all duration-300 rounded-md">
                {topics.map((topic) => (
                  <div
                    ...
                    className={`cursor-pointer rounded-lg px-2 py-2.5 hover:shadow-xl transition-shadow duration-300 flex items-center gap-2  ${selectedOptionTopic === topic.id
                        ? "bg-white"
                        : "bg-transparent"
                      }`}
                  >
                   ...
                   transition-transform duration-300 ease-out"
                    ...
                    <label
                      ...
                      className={`font-medium text-sm cursor-pointer flex gap-2 items-center  ${selectedOptionTopic === topic.id
                          ? "text-blue-600"
                          : "text-gray-700"
                        }`}
                    >
          ...
          <div className="p-2 overflow-scroll relative rounded-md flex-2 border max-h-[100vh] lg:max-h-[77vh] ">
            <div>
              <div className="flex justify-between items-center px-2">
                <div
                  className={`relative flex items-center  transition-all duration-300 ${searchActive ? "w-85" : "w-12"
                    }  rounded-full border-gray-300 `}
                >
                  <input
                    type="text"
                    className={`rounded-full px-4 py-2 text-sm ring ring-[#5C81D9] text-[#5C81D9] transition-all duration-300 ${searchActive ? "w-full opacity-100" : "w-0 opacity-0"
                      } focus:outline-none`}
              ...
              {isLoad ? (
                ...
                <div className="border-gray-300 border-t-2 gap-4 pt-2 ">
                ...
                -translate-x-1/2 -translate-y-1/2 text-3xl text-gray-700 
                opacity-0 group-hover:opacity-100 transition-all duration-300"
                      ...
                      <div className="flex items-center justify-center h-[70vh] w-full bg-gradient-to-b from-gray-50 to-white rounded-lg border border-dashed border-gray-300 col-span-full">
                        <div className="flex flex-col items-center justify-center">
                          ...
                          <p className="mt-1 text-sm text-gray-500 text-center max-w-md">
                            We couldn't find any WhatsApp templates based on
                            your current filters. Try adjusting your search
