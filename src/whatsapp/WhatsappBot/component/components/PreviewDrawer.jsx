...
export default function PreviewDrawer({
  ...
  function formatMessageBody(text) {
    ...
    // Lists: find consecutive lines starting with "- "
      ...
      <div className="relative h-full">
        <div className="p-3 rounded-md w-fit ">
          <div className="bg-white rounded-xl shadow-md p-4 w-[300px]">
            ...
            <div
              className="text-sm text-black mb-3 mt-4 whitespace-pre-wrap"
              dangerouslySetInnerHTML={{
                __html: formatMessageBody(node?.message || ""),
              }}
            />
            ...
            {/* Footer */}
            <div className=" justify-between text-xs text-gray-600 ">
            ...
            {/* Button */}
            <div
              className="text-green-600 text-center space-x-1 cursor-pointer text-sm  w-full"
              onClick={toggleDrawer}
            >
              <ListIcon size={14} />
              <div className="hover:underline break-words whitespace-pre-wrap">
                {node?.text}
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md max-w-md w-full overflow-hidden mr-12">
            ...
            <div className="p-4">
              <pre className="text-gray-900 text-wrap break-words text-sm font-semibold"
                dangerouslySetInnerHTML={{
                  __html: formatMessageBody(node?.urlbuttonbody || ""),
                }}
              >
