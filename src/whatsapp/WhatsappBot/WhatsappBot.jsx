              ...
              <div className="flex flex-col sm:flex-row sm:justify-between items-center mb-4 bg-white">
                <h2 className="text-lg font-semibold text-gray-800 flex items-center gap-2 mb-2 sm:mb-0">
                  ...
                  <div className="relative inline-block" ref={dropdownRef}>
                    ...
                    {isOpen && (
                      <div
                        className="absolute left-0 mt-1 w-64 max-h-40 overflow-y-auto bg-white border rounded-md shadow-lg"
                      >
                        {allBots.map((bot, index) => (
                          ...
                          >
                            <div className="text-[0.8rem] font-medium text-gray-800">
                              {highlightMatch(String(bot.botName || ""), search)}
                            </div>
                            {dropdownItemsHidden.map((item, idx) => {
                              const iconMap = {
                                Export: <FileDownloadOutlinedIcon sx={{ fontSize: 17 }} />,
                              };
                              return (
                                <button
                                  key={idx}
                                ...
                                >
                                  {dropdownItems.map((item, idx) => {
                                    const iconMap = {
                                      ...
                                      Duplicate: <FileCopyOutlinedIcon sx={{ fontSize: "17px" }} />,
                                      Export: <FileDownloadOutlinedIcon sx={{ fontSize: "17px" }} />,
                                    };
                                    return (
                                      <button
                                        key={idx}
