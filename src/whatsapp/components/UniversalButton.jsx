  ...
  return (
    <>
      <button
        ...
        style={style}
        className={`flex items-center font-p text-sm justify-center gap-2 px-4 py-2 cursor-pointer rounded-lg shadow-md focus:outline-none  focus:ring-0  ${getButtonStyles()} ${
