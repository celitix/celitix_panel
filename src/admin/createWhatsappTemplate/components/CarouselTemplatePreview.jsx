...
import { MdArrowForwardIos, MdOutlineArrowBackIos, MdOutlineDeleteForever, } from "react-icons/md";
import { FaExternalLinkAlt, FaExternalLinkSquareAlt, FaPlay, } from "react-icons/fa";
...
const CarouselTemplatePreview = ({
  ...
  return (
    ...
    >
      ...
      {format && (
        <div
          className="w-full h-auto px-3 py-2 mb-3 overflow-auto text-sm text-gray-800 break-words bg-gray-200 border border-gray-200 rounded-md max-h-24"
