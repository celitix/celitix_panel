...
const ManageDltTemplateTable = ({ id, name }) => {
    ...
    const columns = [
        { field: 'sn', headerName: 'S.No', flex: 1, minWidth: 100 },
        { field: 'userid', headerName: 'Userid', flex: 1, minWidth: 120 },
        { field: 'templatename', headerName: 'Template Name', flex: 1, minWidth: 180 },
        { field: 'templateid', headerName: 'Template ID', flex: 1, minWidth: 150 },
        ...
        { field: 'consenttype', headerName: 'Consent type', flex: 1, minWidth: 160 },
