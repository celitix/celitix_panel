...
const ManagePlan = () => {
  ...
  const [isCheckedcreate, setIsCheckedsetIsChecked] = useState(false);
  ...
  async function handleCreatePlanSave() {
    ...
    try {
      ...
      if (
        !createData.planName ||
        !createData.planType ||
        !createData.characterLimit ||
        !createData.orderQueueSize ||
        !createData.initialQueueSize ||
        !createData.triggerQueueSize
      ) {
      ...
      <div>
        ...
        <div className="w-full mt-2">
          <div className="flex flex-wrap items-end w-full gap-2 mb-5">
            ...
            <div className="w-full sm:w-52 flex gap-2 items-en">
        ...
        >
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-center">
              <UniversalButton
                // label="Save"
                label={isCreatePlan ? "Saving..." : "Save"}
                disabled={isCreatePlan}
