...
const AddSMTP = () => {
    ...
    const [searchTerm, setSearchTerm] = useState({ host: "", user: "" });
    ...
    const filteredRows = rows.filter((row) => {
        const matchesHost = row.hostName?.toLowerCase().includes(searchTerm.host.toLowerCase());
        const matchesUser = row.userName?.toLowerCase().includes(searchTerm.user.toLowerCase());
    ...
    return (
        <>
            ...
            <div className="flex flex-wrap gap-2 items-end w-full my-4">
                <div className="w-full md:w-64">
                    <InputField
                        label="Search Host Name"
                        value={searchTerm.host}
                        onChange={(e) => setSearchTerm({ ...searchTerm, host: e.target.value })}
                ...
                <div className="w-full md:w-64">
                    <InputField
                        ...
                        onChange={(e) => setSearchTerm({ ...searchTerm, user: e.target.value })}
            ...
            <div className="w-full">
                <DataTable rows={filteredRows} col={smtpColumns} getRowHeight={null} />
            </div>
            <Dialog
            ...
            >
                <div className="space-y-4">
                    <div className={`grid grid-cols-1 ${editMode ? 'md:grid-cols-1' : 'md:grid-cols-1'} gap-2`}>
                        {/* <DropdownWithSearch
