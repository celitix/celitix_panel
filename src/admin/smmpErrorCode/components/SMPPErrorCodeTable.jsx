...
const SMPPErrorCodeTable = ({ id, name }) => {
  ...
  const handleSMPPErrorEdit = (value) => {
    // console.log(value)
  ...
  const columns = [
    { field: "sn", headerName: "S.No", flex: 1, minWidth: 90 },
    { field: "service", headerName: "Service", flex: 1, minWidth: 110 },
    { field: "vendorecstatus", headerName: "Vendor EC Status", flex: 1, minWidth: 180 },
    { field: "vendorec", headerName: "Vendor EC", flex: 1, minWidth: 140 },
    { field: "vendorecdescription", headerName: "Vendor EC Description", flex: 1, minWidth: 210 },
    { field: "displayecstatus", headerName: "Display EC Status", flex: 1, minWidth: 180 },
    { field: "displayec", headerName: "Display EC", flex: 1, minWidth: 160 },
    { field: "displayecdescription", headerName: "Display EC Description", flex: 1, minWidth: 220 },
    { field: "cbondnd", headerName: "CB On DND", flex: 1, minWidth: 140 },
    { field: "cbondelivery", headerName: "CB On Delivery", flex: 1, minWidth: 160 },
    {
      field: "action",
      headerName: "Action",
      flex: 1,
      ...
      renderCell: (params) => (
        <>
          <CustomTooltip title="Edit Routing" placement="top" arrow>
            <IconButton onClick={() => handleSMPPErrorEdit(params.row.sr_no)}>
              <EditNoteIcon
                sx={{
                  fontSize: "1.2rem",
                  color: "gray",
