          ...
          <div className="lg:w-100 md:w-100 flex flex-wrap gap-4">
            ...
            <div className="flex items-center gap-2">
              <RadioButton
                ...
                value="enable"
                onChange={handleChangeEmployeeidViewStatus}
                checked={employeeidviewStatus === "enable"}
              />
              <label
            ...
            <div className="flex items-center gap-2">
              <RadioButton
                ...
                value="disable"
                onChange={handleChangeEmployeeidViewStatus}
                checked={employeeidviewStatus === "disable"}
              />
              <label
      ...
      >
        <div className="space-y-4">
          ...
          <div className="lg:w-100 md:w-100 flex flex-wrap gap-4">
            ...
            <div className="flex items-center gap-2">
              <RadioButton
                inputId="employeeideditOption1"
                name="employeeideditredio"
                value="enable"
                onChange={handleChangeEmployeeidEditStatus}
                checked={employeeideditStatus === "enable"}
              />
              <label
                htmlFor="employeeideditOption1"
                className="text-gray-700 font-medium text-sm cursor-pointer"
              >
                Active
              </label>
            ...
            <div className="flex items-center gap-2">
              <RadioButton
                inputId="employeeideditOption2"
                name="employeeideditredio"
                value="disable"
                onChange={handleChangeEmployeeidEditStatus}
                checked={employeeideditStatus === "disable"}
              />
              <label
                htmlFor="employeeideditOption2"
                className="text-gray-700 font-medium text-sm cursor-pointer"
              >
                Inactive
              </label>
