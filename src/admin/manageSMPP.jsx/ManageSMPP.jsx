...
const ManageSMPP = () => {
  ...
  const columns = [
    ...
    { field: "sockets", headerName: "Sockets", flex: 1, minWidth: 80 },
    {
      field: "connectivity",
  ...
  return (
    ...
    <>
      ...
      <div>
        <h1 className="flex justify-center items-center font-semibold text-2xl text-gray-700">Manage SMPP</h1>
        <div className="flex flex-wrap gap-2 items-end justify-between w-full my-4">
        ...
        <div className="w-full">
          <ManageSMPPTable id="manageSMPPTable" name="manageSMPPTable" data={data} handleFetchSmppDetails={handleFetchSmppDetails} />
        </div>
      </div>
      {/* <Dialog
