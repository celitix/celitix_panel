...
import { createInstaTemplate } from "@/apis/instagram/Instagram";
...
const AddTemplate = ({ onAddTemplate, setAddTemplate }) => {
  ...
  const [selectedInstaUser, setSelectedInstaUser] = useState("");
      ...
      <div className="flex flex-col">
        <div className="w-full sm:w-56">
          <DropdownWithSearch
            id="instaUserList"
            name="instaUserList"
            label="Instagram User List"
            placeholder="Insta User List"
