...
const UniversalInstaButton = ({
  ...
  // Instagram Color Palette logic
  const variants = {
    // primary: "bg-gradient-to-tr from-[#FFD600] via-[#FF7A00] via-[#FF0069] to-[#D300C5] text-white shadow-md hover:opacity-90",
    primary: "bg-gradient-to-tr from-[#FFD600]/10 via-[#FF0069]/10 to-[#D300C5]/10 text-[#C13584] border border-[#FF0069]/20 hover:from-[#FFD600]/20 hover:to-[#D300C5]/20 shadow-sm",
    secondary: "bg-[#efefef] hover:bg-[#dbdbdb] text-[#262626]",
    outline: "bg-transparent border border-[#dbdbdb] text-[#262626] hover:bg-[#fafafa]",
    danger: "bg-[#fa3e3e] hover:bg-[#d92121] text-white shadow-sm",
  };

  const baseStyles = "relative inline-flex items-center justify-center px-6 py-2 text-sm font-semibold rounded-lg transition-all duration-200 ease-in-out active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100";
  ...
  return (
    ...
    >
      ...
      <span className="relative z-10 flex items-center justify-center gap-2">
        {/* {isLoading ? (label === "Add" ? "Adding..." : "Saving...") : label} */}
        {isLoading ? (
