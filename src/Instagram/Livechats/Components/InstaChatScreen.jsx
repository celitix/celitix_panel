...
const InstaChatScreen = ({
  ...
  //   if(fileUploaded){
  //      // Upload file to your server (returns URL probably)
...
const handleSendClick = async () => {
  ...
  return (
    <>
      <div className="h-full bg-white flex w-full mt-15 md:mt-0">
        <div className="flex flex-col w-full ">
          ...
          <div className="h-[100vh] overflow-hidden relative">
            <div className="absolute inset-0 bg-no-repeat z-0 bg-cover w-full h-full opacity-10 bg-center bg-[url(/instachatbg.webp)]" />
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white/80 shadow-xl backdrop-blur">
                        ...
                        <div className="flex flex-col items-center gap-4 px-6 py-8 text-center">
                          ...
                          <p className="text-sm text-gray-600 max-w-md">
                            Start the conversation to see messages here. Your
                            chats will appear in real time as soon as a reply
                            comes in.
                          </p>
                          ...
                          <div className="mt-2 grid w-full grid-cols-1 gap-3 sm:grid-cols-3">
                            ...
                            <div className="flex items-start gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2">
                              ...
                              <div className="text-left">
                                ...
                                <p className="text-[11px] text-gray-500">
                                  Text • Media • Stickers • GIFs • Templates •
                                  Posts and much more
                                </p>
                              </div>
                            </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        className={`max-w-xs relative px-4 py-2 cursor-pointer z-2 break-words whitespace-pre-line ${
                          msg.type === "text"
                            ? fromMe
                      ...
                      {msg.reactions && msg.reactions.length > 0 && (
                        <div
                          className={`mt-1 flex space-x-1 text-sm ${
                      ...
                      {activeEmojiPickerIdx === idx && (
                        <div
                          className={`p-1 rounded-full flex items-center justify-center absolute mb-2 z-[9999] top-0 ${
                            fromMe ? "right-80" : "left-80"
                          }`}
                        >
                          <CustomEmojiPicker
                      ...
                      <div
                        className={`p-1 rounded-full flex gap-2 items-center justify-center absolute mx-2 z-50 top-0 ${
                          fromMe ? "right-85" : "left-85"
                        }`}
                      >
                        {/* Download Icon */}
                        {msg.type !== "text" && (
          ...
          <div className="p-2 border-t bg-white w-full flex items-center gap-2 sm:gap-3 z-10 shadow rounded-br-md bottom-0 h-22">
            ...
            <div className="relative flex gap-1.5">
              ...
              <button
                ...
                className={`flex items-center justify-center w-8 h-8 sm:w-9 sm:h-9 cursor-pointer bg-black text-white rounded-full shadow-md transition-transform ${
