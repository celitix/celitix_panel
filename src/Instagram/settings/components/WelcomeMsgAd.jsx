    ...
    <>
      <div className="">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="w-full md:w-2/3 bg-white rounded-lg shadow p-4 space-y-6 flex flex-col items-start justify-start overflow-scroll h-screen pb-70">
          ...
          <div className="w-full md:w-1/4 overflow-scroll  pb-0 lg:pb-110">
          <div className="mx-auto w-[280px] md:w-[340px] h-auto lg:w-[250px] 2xl:w-[340px] rounded-[2rem] border-4 border-black shadow-lg  relative bg-white">
            {/* Top Status Bar */}
