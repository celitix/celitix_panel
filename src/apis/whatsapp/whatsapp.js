...
export const getWabaListForAgent = async () => {
  return await fetchWithAuth("/whatsapp/getwabadetails", {
    method: "GET",
  });
};
...
// update waba status
export const updateWabaStatus = async (data) => {
  return await fetchWithAuth("/whatsapp/changestatus", {
    method: "POST",
...
// /whatsapptemplate/getBusinessTemplateDetails?wabaSrno=105 - POST - getBusinessTemplateDetails
export const getBusinessTemplateDetails = async (data) => {
  return await fetchWithAuth(
    `/whatsapptemplate/getBusinessTemplateDetails?wabaSrno=${data.srno}`,
    {
      method: "POST",
...
// /whatsapptemplate/UpdateBusinessTemplateDisplayName?wabaSrno=105&newDisplayName=Health - POST - updateWabaDisplayName

export const updateWabaDisplayName = async (data) => {
  return await fetchWithAuth(
    `/whatsapptemplate/UpdateBusinessTemplateDisplayName?wabaSrno=${data.wabaSrno}&newDisplayName=${data.newDisplayName}`,
    {
      method: "POST",
       body: JSON.stringify(data),
    },
...
export const getUserPreference = async (data) => {
  return await fetchWithAuth(
    `/UserPreferencesReport?pageIndex=${data.pageIndex}&pageSize=${data.pageSize}`,
    {
      method: "GET",
    },
  );
...
export const clickDetailsReport = async (data) => {
  return await fetchWithAuth(
    `/click/whatsappClickDetailsReport?userSrno=${data?.userSrno}&campaignSrno=${data?.campaignSrno}`,
    {
      method: "POST",
    },
  );
...
// export unsubscribe number
export const exportUnsubscribeNumber = async (data) => {
  return await fetchWithAuth(`/report/export-unsubscribe-data`, {
    method: "POST",
    body: JSON.stringify(data),
  });
};

// suggestedAiResponse - POST

// /LiveChat/suggest-next-chat?wabaNumber=919727782882&mobileNo=918758979037&limit=50&message=summarise above chat

// call settings
export const suggestedAiResponse = async (data) => {
  return await fetchWithAuth(
    `/LiveChat/suggest-next-chat?wabaNumber=${data.wabaNumber}&mobileNo=${data.mobileNo}&limit=${data.limit}&message=${data.message}`,
    {
      method: "POST",
      body: JSON.stringify(data),
    },
...
// AddUpdateWhatsapp
export const addUpdateWhatsappLibrary = async (data) => {
  return await fetchWithAuth(
    `/whatsappTemplateLibrary/addUpdateWhatsappTempleteLibrary`,
    {
      method: "POST",
      body: JSON.stringify(data),
    },
...
// DeleteWhatsapp
export const deleteWhatsappLibrary = async (srNo) => {
  return await fetchWithAuth(
    `/whatsappTemplateLibrary/deleteTempLibBySrno?srNo=${srNo}`,
    {
      method: "DELETE",
    },
  );
...
// GetWhatsapp
export const getWhatsappLibrary = async (data) => {
  return await fetchWithAuth(
    `/whatsappTemplateLibrary/getTemplateJson?srNo=${data.srNo}`,
    {
      method: "GET",
    },
  );
...
// /whatsappTemplateLibrary/addUpdateWhatsappTempleteLibrary - POST
// payload
// {
//     "srNo": 3,
//     "category": "Video",
...
//         "limited_time_offer": {
//           "text": "<LIMITED_TIME_OFFER_TEXT>", - Required. Maximum 16 characters.
//           "has_expiration": <HAS_EXPIRATION> - true or false - default set to true
//         }
//       },
...
//     {
//       "type": "body",
//       "text": "Welcome to Lucky Shrub, {{1}}!\n\nUse code *{{2}}* to get {{discount_amount}} off of your first purchase!",
//       "example": {
...
//     },
//     {
//       "type": "buttons", - URL Max pair - 3 ,phone number Max pair - 1, quick reply max -5
//       "buttons": [
//         {
//           "type": "url",
//           "text": "View deals",
...
//   "type": "URL",
//   "text": "<TEXT>",
//   "url": "<URL>", https://www.luckyshrub.com/shop?promo={{1}} - 2000 characters maximum.
...
// {
//   "type": "copy_code",
//   "example": "<OFFER_CODE_EXAMPLE>" Required Maximum 15 characters.
// },
//       ]
//     }
//   ]
// }',
//     "templateTitle": "Video Template",
//     "templateBody": "Video Body"
// }

// components array for carousel
// "components": [
//       {
//         "type": "body",
...
// Bulleted List: - text or * text (with a space)
// Numbered List: 1. text, 2. text (with a space)
