...
// cancel campaign
export const cancelScheduleCampaignSms = async ({
  srno,
  selectedUserId = "0",
}) => {
  return await fetchWithAuth(
...
// Service ID Wise Summary Report
export const ServiceIdWiseSummaryReport = async () => {
  return await fetchWithAuth("/ServiceIdWiseSummaryReport", {
    method: "GET",
  });
};
...
// download detailed logs
export const fetchDetailsAttachment = async (
  srno,
  mbno,
  selectedUserId = "0",
) => {
