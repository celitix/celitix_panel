...
const ResellerLogin = () => {
  ...
  async function handleLogin() {
    ...
    try {
      ...
      // const domain = "waba.zectagon.in";
      // const domain = "app.celitix.com";
      // const domain = "waba.zectagon.in";
      // const domain = "digitalyug.in";
      // const domain = "msg.itbizcon.in";
  ...
  async function handleVerifyNumberRequest() {
    ...
    let payload = {
      userId: username,
      mobileNo: `${selectedCode}${verifyNumber}`,
      domain: basicDetails.domain,
    };
    ...
    try {
      ...
      toast.success(res?.data?.msg || "OTP Sent to your mobile number");
      setStep("verifynumberotp");
    } catch (error) {
      console.error("Error in handleVerifyNumberRequest:", error);
      toast.error("Something went wrong. Please try again.");
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gradient-to-br from-[#EAF7FF] via-slate-50 to-slate-50">
      <div className="bg-white flex rounded-2xl shadow-2xl h-full md:h-[90%] w-[95%]">
        ...
        <div className="flex items-center justify-center rounded-2xl p-6 w-full lg:w-1/2 lg:p-12 border-2 border-cyan-600 m-4 bg-gray-50 shadow-2xl overflow-scroll">
          {/* <div className=""> */}
          {step === "login" && (
            <>
              <motion.div
                ...
                className="h-full md:h-auto flex flex-col justify-center"
              >
                <div className="flex flex-col items-center justify-center my-2">
                  <h3 className="text-3xl md:text-5xl text-center font-medium my-2 playf">
                    Welcome Back
                  </h3>
                  <p className="text-base md:text-sm my-2 text-center">
          ...
          {step === "verifyNumber" && (
            <motion.div
              ...
              className="p-1 "
            >
              <h1 className="text-3xl md:text-4xl font-semibold text-center my-2 playf">
                {/* Verify Number */}
