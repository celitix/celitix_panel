    ...
    return (
        <div className="mx-auto bg-white rounded-2xl shadow-lg p-2">
            ...
            >
                ...
                <div className=" quill-preview quill-content  w-45 md:w-170  max-w-none text-gray-800 whitespace-pre-wrap break-words text-sm overflow-auto max-h-180 min-h-130 h-auto">
