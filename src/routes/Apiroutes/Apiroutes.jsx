...
import ManageTemplateRCSDocs from "@/ApiDocs/rcs/manageTemplate/ManageTemplateRCSDocs";
...
import GetTemplate from "@/ApiDocs/whatsapp/GetTemplate";
...
// Help
import Help from "@/ApiDocs/help/Help";

// Email
import SendEmailDocs from "@/ApiDocs/Email/SendEmailDocs";

// Instagram
import InstaApiDocsSetting from "@/ApiDocs/instagram/InstaApiDocsSetting";
  ...
  return (
    <Routes>
      <Route path="/" element={<DocsMainLayout />}>
        ...
        <Route
          path="/manage-template-rcs"
          element={<ManageTemplateRCSDocs />}
        />
        ...
        <Route
          path="/submit-template-whatsapp"
          element={<SubmitTemplateWhatsapp />}
        />
        <Route
          path="/send-template-whatsapp"
          element={<SendTemplateWhatsapp />}
        />
        <Route path="/send-message-whatsapp" element={<SendMessage />} />
        <Route path="/send-messages-whatsapp" element={<SendMessageNew />} />
        <Route path="/get-template-whatsapp" element={<GetTemplate />} />
        ...
        <Route
          path="/submit-template-twowaysms"
          element={<SubmitTemplateTwoWaySms />}
        />
        <Route
          path="/update-template-twowaysms"
          element={<UpdateTemplateTwoWaySms />}
        />
        <Route
          path="/delete-template-twowaysms"
          element={<DeleteTemplateTwoWaySms />}
        />

        {/* Authentication */}
        <Route
          path="authentication"
          element={<IntroductionDocsAuthentication />}
        />
        <Route
          path="/submit-template-authentication"
          element={<SubmitTemplateAuthentication />}
        />
        <Route
          path="/update-template-authentication"
          element={<UpdateTemplateAuthentication />}
        />
        <Route
          path="/delete-template-authentication"
          element={<DeleteTemplateAuthentication />}
        />

        {/* Outbound */}
        <Route path="outbound" element={<IntroductionDocsOutbound />} />
        <Route
          path="/submit-template-outbound"
          element={<SubmitTemplateOutbound />}
        />
        <Route
          path="/update-template-outbound"
          element={<UpdateTemplateOutbound />}
        />
        <Route
          path="/delete-template-outbound"
          element={<DeleteTemplateOutbound />}
        />

        {/* inbound */}
        <Route path="inbound" element={<IntroductionDocsInbound />} />
        <Route
          path="/submit-template-inbound"
          element={<SubmitTemplateInbound />}
        />
        <Route
          path="/update-template-inbound"
          element={<UpdateTemplateInbound />}
        />
        <Route
          path="/delete-template-inbound"
          element={<DeleteTemplateInbound />}
        />

        {/* missedcall */}
        <Route path="missedcall" element={<IntroductionDocsMissedCall />} />
        <Route
          path="/submit-template-missedcall"
          element={<SubmitTemplateMissedCall />}
        />
        <Route
          path="/update-template-missedcall"
          element={<UpdateTemplateMissedCall />}
        />
        <Route
          path="/delete-template-missedcall"
          element={<DeleteTemplateMissedCall />}
        />

        {/* click two call */}
        <Route path="clicktwocall" element={<IntroductionDocsClickTwoCall />} />
        <Route
          path="/submit-template-clicktwocall"
          element={<SubmitTemplateClickTwoCall />}
        />
        <Route
          path="/update-template-clicktwocall"
          element={<UpdateTemplateClickTwoCall />}
        />
        <Route
          path="/delete-template-clicktwocall"
          element={<DeleteTemplateClickTwoCall />}
        />
        ...
        {/* Eamil */}
        <Route path="/sendEmailDocs" element={<SendEmailDocs />} />

        {/* Instagram */}
        <Route path="/instagramSetting" element={<InstaApiDocsSetting />} />
      </Route>
