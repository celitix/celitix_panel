    ...
    try {
      ...
      if (response) {
        const data = {
          ...
          lookupStatus: response?.lookupStatus,
          lookupDescription: response?.lookupDescription,
          originalOperator: response?.originalOperator,
          originalCircle: response?.originalCircle,
          ported: response?.ported?.toLowerCase?.() === "yes",
          portedOperator: response?.portedOperator,
          portedCircle: response?.portedCircle,
        };
