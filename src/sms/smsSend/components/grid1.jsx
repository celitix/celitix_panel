...
export const Grid1 = ({
  ...
  // }, [inputDetails]);
  return (
    <div className="border lg:w-[40%] p-2 space-y-2 rounded-lg shadow-md w-full">
      <div className="grid xl:grid-cols-3 lg:grid-cols-1 md:grid-cols-1 grid-cols-1 gap-2">
      ...
      <div className="flex flex-col gap-2">
        ...
        {(inputDetails.templateType === 1 ||
          inputDetails.templateType === 2) && (
            <div className="grid xl:grid-cols-2 lg:grid-cols-1 grid-cols-1 gap-2">
              <DropdownWithSearch
                label="DLT Template"
                id="Dlt Template"
                name="Dlt Template"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="border border-gray-300 rounded-lg px-4 py-2 bg-white">
            <p className="text-[13px] text-gray-500 mb-1">Characters</p>
            <p className="text-sm font-medium text-gray-800">
              {inputDetails?.message?.length || 0}/1000
            </p>
          </div>

          {/* SMS Units */}
          <div className="border border-gray-300 rounded-lg px-4 py-2 bg-white">
            <p className="text-[13px] text-gray-500 mb-1">SMS Units</p>
            <p className="text-sm font-medium text-gray-800">
              {getSmsUnit(
                inputDetails?.message,
                inputDetails?.unicode === 0 ? false : true
          ...
          {/* Entity ID */}
          <div className="border border-gray-300 rounded-lg px-4 py-2 bg-white">
            <p className="text-[13px] text-gray-500 mb-1">Entity ID</p>
            <p className="text-sm font-medium text-gray-800 break-words">
              {inputDetails?.entityId || "N/A"}
            </p>
          </div>

          {/* Template ID */}
          <div className="border border-gray-300 rounded-lg px-4 py-2 bg-white">
            <p className="text-[13px] text-gray-500 mb-1">Template ID</p>
            <p className="text-sm font-medium text-gray-800 break-words">
              {inputDetails?.templateId || "N/A"}
            </p>
          </div>
        </div>
