...
const SmsDLTtemplatenew = () => {
    ...
    const cols = [
        ...
        },
        {
            ...
            minWidth: 300,
            renderCell: (params) => (
                <div className="text-sm text-gray-700 text-wrap py-2">
                    {params.value}
                </div>
            ),
        },
    ...
    function handleDownload() {
        ...
        // 1. Get the column headers/keys
        const headerKeys = cols.map((col) => col.field);

        // 2. Map the data into an array of arrays (one array per row)
        const dataRows = rows.map((rowData) =>
            headerKeys.map((field) => rowData[field] ?? "")
        );

        const name = "DLT Template List";

        // Pass the headers and the 2D array of data
        exportToExcel(headerKeys, dataRows, name);
        toast.success("File Downloaded Successfully");
    }
                      ...
                      <FaDownload className="text-green-600" />
                                ...
                                <div className="text-sm leading-relaxed">
                                    ...
                                    <p className="text-gray-700">
                                        When registering the template, it is mandatory to pre-tag each
                                        variable chosen in the content.
                                    </p>
                                    <p className="text-gray-700">
                                        Choose the correct tag from the dropdown menu under{" "}
                                        <span className="font-medium">“Select Variable Tag”</span> to
                                        pre-tag the variable.
                                    </p>
                                    <p className="text-gray-700">
                                        Please provide a sample value for each selected tag to proceed.{" "}
                                        <a
                                            href="#"
                  ...
                  <button className="mt-4 px-4 py-2 border border-gray-800 text-gray-800 text-sm font-semibold rounded shadow hover:bg-gray-100 flex items-center gap-2">
                    KNOW MORE <span>➤</span>
                        ...
                        <div className="w-full mt-6 p-4 bg-gray-50 border rounded-md text-sm text-gray-700 leading-relaxed">
                            ...
                            {/* Copy/Paste Option */}
                            <div className="mb-4">
                                <h3 className="font-medium text-gray-900">A) Copy/Paste Message</h3>
                                <ol className="list-decimal list-inside space-y-1 mt-1">
                                    <li>Copy your desired message into the message box area.</li>
                                    <li>Select the word(s) you want to convert into a variable.</li>
                                    <li>
                                        Click the <strong>“Add Variable”</strong> button, or type{" "}
                                        <code>#var#</code>.
                                    </li>
                                    <li>
                                        Click <strong>“Submit”</strong> to submit your content template
                                        request.
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div className="mb-4">
                                <h3 className="font-medium text-gray-900">B) Create New Message</h3>
                                <ol className="list-decimal list-inside space-y-1 mt-1">
                                    <li>Type your desired message into the message box.</li>
                                    <li>
                                        To add variables, click <strong>“Add Variable”</strong> or type{" "}
                                        <code>#var#</code>.
                                    </li>
                                    <li>
                            ...
                            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 rounded-md">
                                ...
                                <ul className="list-disc list-inside mt-1 space-y-1 text-yellow-700">
                                    ...
                                    <li>
                                        Always include your <strong>brand or business name</strong> in
                                        the content.
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        Do not manually modify <code>#var#</code> placeholders in the
                                        message box.
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="mt-4">
                                ...
                                <p className="italic text-gray-700 mt-1">
                                    Congratulations! You have received a shopping voucher worth Rs.{" "}
                                    <code>#var#</code>, valid till <code>#var#</code>. <br />– Brand
                                    Name
                                </p>
                            </div>
                        </div>
...
export default SmsDLTtemplatenew;
