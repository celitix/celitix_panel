    ...
    },
    {
      ...
      renderCell: (params) => (
        <div className="flex items-center md:justify-center justify-end h-full">
          ...
          >
            {data[params.row.id] ? (
              <div className="w-[320px] max-w-full mx-2 px-1 max-h-200 overflow-scroll">
                <div className="grid grid-cols-2 gap-y-2 text-sm text-gray-700">
                  {[
                    ...
                    <React.Fragment key={key}>
                      ...
                      <div className="text-right font-semibold text-gray-800 border-b border-gray-200 pb-2 text-nowrap break-words">
                        {key === "isunicode"
