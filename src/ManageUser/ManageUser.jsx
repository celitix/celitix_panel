...
const ManageUser = () => {
  ...
  return (
    <div>
      <div className="flex flex-wrap items-end justify-center w-full gap-4 mb-3 align-middle">
        <h1>
      ...
      <div className="flex flex-wrap items-end justify-start w-full gap-4 pb-3 align-middle">
        ...
        {/* <div className="w-full sm:w-48">
          <DropdownWithSearch
            ...
            name="manageRole"
            options={[
              { value: "Direct End User", label: "User" },
              { value: "Reseller", label: "Reseller" },
              // { value: "Sales Person", label: "Sales Person" },
              // { value: "Account User", label: "Accountant" },
            ]}
      ...
      <div>
        ...
        <ManageUserTable
          allUsers={allUsers}
          fetchAllUsersDetails={fetchAllUsersDetails}
        />
      </div>
    </div>
  );
