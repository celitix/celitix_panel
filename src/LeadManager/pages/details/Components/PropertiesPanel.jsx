...
export default function PropertiesPanel() {
  return (
    <div className="p-2 border-b space-y-4 overflow-y-auto">
      ...
      <div className="space-y-1">
        ...
        <div className="text-xs text-gray-600">by Mon, Jul 7, 2025 1:15 PM</div>
      </div>
      ...
      <div className="space-y-1">
        ...
        <div className="text-xs text-gray-600">by Mon, Jul 7, 2025 9:00 PM</div>
      </div>

      {/* Tags, Type, Status, Priority, Update */}
      <div className="space-y-2 px-2 overflow-auto  h-70">
