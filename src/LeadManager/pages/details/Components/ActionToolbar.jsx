...
export default function ActionToolbar({ onToggleCollapse }) {
    return (
        <div className="bg-white px-2 md:px-2 py-2 flex flex-wrap md:flex-nowrap items-center space-x-1 md:space-x-2 border-b">
            {/* Left group */}
