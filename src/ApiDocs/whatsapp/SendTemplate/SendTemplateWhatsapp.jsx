...
--header 'Content-type: application/json' \
 `;
  ...
  const AuthenticationTemplatesResponseheaders = [{ key: "", value: "" }];
    ...
    >
      <div className=" p-4 lg:p-6 overflow-y-auto w-4xl mx-auto ">
            ...
            <div className="flex flex-col items-center justify-center md:text-start w-full  sm:text-center mt-2">
              ...
              <ul className="space-y-2 p-4">
                <li className="relative pl-6">
                  ...
                  />
                  <span className="font-medium"> Call-to-Action —</span> Allows
                  your customer to call a phone number and visit a website.
                </li>
                ...
                <li className="relative pl-6">
                  ...
                  <CircleIcon
                    ...
                    style={{ fontSize: "0.4rem" }}
                  />
                  <span className="font-medium">Quick Reply —</span> Allows your
                  customer to return a simple text message.
                </li>
              </ul>

              <p className="mt-2">
                These buttons can be attached to text messages or media
                messages. Once your interactive message templates have been
                created and approved, you can use them in notification messages
                as well as customer service/care messages.
              </p>

              <p className="mt-2">
                To send an interactive message template, make a POST call to
                /PHONE_NUMBER_ID/messages and attach a message object with
                type=template. Then, add a{" "}
                <span className="text-blue-500 hover:underline">
                  <Link
                    to="https://developers.facebook.com/docs/whatsapp/cloud-api/reference/messages#template-object"
                    target="_blank"
                ...
                <span className="text-blue-500 hover:underline">
                  <Link
                    to="https://developers.facebook.com/docs/whatsapp/cloud-api/reference/messages#button-parameter-object"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    button
        ...
        <section id="authentication-templates" className="mb-16">
          ...
          <div className="mt-5 flex justify-center items-center">
            <Table columns={RequestParameterAuthenticationTemplateColumn}>
              ...
              <tr className={` ${colors.tableBorder} border-b`}>
                ...
                <td className="px-4 py-4  text-sm popins">
                  The one-time password or verification code to be delivered to
                  the customer. <br />
                  <br />
                  Note that this value must appear twice in the payload. <br />
                  <br />
          ...
          <div className="mt-5 mx-auto">
            <Table columns={RequestParameterAuthenticationTemplateColumn}>
              <tr className={` ${colors.tableBorder} border-b`}>
                ...
                <td className="px-4 py-4  text-sm popins">
                  The customer phone number that the message was sent to. This
                  may not match wa_id.
                </td>
              ...
              <tr className={` ${colors.tableBorder} border-b`}>
                ...
                <td className="px-4 py-4  text-sm popins">
                  WhatsApp ID of the customer who the message was sent to. This
                  may not match input.
                </td>
                <td className="px-4 py-4">+16315551234</td>
              </tr>
              ...
              <tr>
                ...
                <td className="px-4 py-4  text-sm popins">
                  WhatsApp message ID. You can use the ID listed after "wamid."
          ...
          <div className="mt-5 flex justify-center items-center w-8xl mx-auto">
            <Table columns={HeaderTableColumns}>
              <tr className={`${colors.tableBorder} border-b`}>
                <td className="px-4 py-4 text-sm popins">x-access-token</td>
                <td className="px-4 py-4 text-sm popins text-orange-500">
          ...
          <div className="mt-4 flex flex-col items-center justify-center">
            ...
            <div className="w-full">
              <CodeComponent sampleData={AuthenticationRawBody} />
            </div>
          </div>
        </section>
        ...
        <section id="carousel-template" className="mb-16">
          ...
          <div className=" flex flex-col items-center justify-center md:text-start w-xs md:w-2xl lg:w-3xl mx-auto text-center lg:text-start mt-2">
            <p className="mt-2">
              This document describes how to send a{" "}
              <span className="text-blue-500 hover:underline">
                <Link
                  to="https://developers.facebook.com/docs/whatsapp/business-management-api/message-templates/carousel-templates"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  carousel template
            ...
            <p className="mt-4">
              ...
              endpoint to send a carousel template message using a carousel
              template with an APPROVED status.
            </p>
          </div>
            ...
            <Table columns={RequestParameterCarouselTemplateColumn}>
              <tr className={` ${colors.tableBorder} border-b`}>
                ...
                <td className="px-4 py-4  text-sm popins">
                  ...
                  <br />
                  <br />
                  Message bubble text variable. <br />
                  <br />
                  There is no maximum character limit on this value, but counts
                  against the message bubble limit of 1024 characters.
                </td>
              ...
              <tr className={` ${colors.tableBorder} border-b`}>
                ...
                <td className="px-4 py-4  text-sm popins">
                  ...
                  <br />
                  <br />
                  Zero-indexed order in which button appears at the bottom of
                  the template message. 0 indicates the first button, 1
                  indicates second button, etc.
                </td>
              ...
              <tr className={` ${colors.tableBorder} border-b`}>
                ...
                <td className="px-4 py-4  text-sm popins">
                  ...
                  <br />
                  <br />
                  Zero-indexed order in which card appears within the card
                  carousel. 0 indicates first card, 1 indicates second card,
                  etc.
                </td>
                <td className="px-4 py-4">0</td>
              </tr>
              ...
              <tr className={` ${colors.tableBorder} border-b`}>
                ...
                <td className="px-4 py-4  text-sm popins">
                  ...
                  <br />
                  <br />
                  Card body text variable. <br />
                  <br />
                  There is no maximum character limit on this value, but counts
                  against the card body text limit of 160 characters.
                </td>
                <td className="px-4 py-4">20OFF</td>
              </tr>
              ...
              <tr className={` ${colors.tableBorder} border-b`}>
                ...
                <td className="px-4 py-4  text-sm popins">
                  ...
                  <br />
                  <br />
                  Uploaded media asset ID. Use the{" "}
                  <span className="text-blue-500 hover:underline">
                    <Link
              ...
              <tr className={` ${colors.tableBorder} border-b`}>
                ...
                <td className="px-4 py-4  text-sm popins">
                  <span className="font-medium text-black">Optional</span>{" "}
                  <br />
                  <br />
              ...
              <tr className={` ${colors.tableBorder} border-b`}>
                ...
                <td className="px-4 py-4  text-sm popins">
                  ...
                  of the template to be sent in the template message.
                </td>
                <td className="px-4 py-4">en_US</td>
              </tr>
              ...
              <tr className={` ${colors.tableBorder} border-b`}>
                ...
                <td className="px-4 py-4  text-sm popins">
                  ...
                  <br />
                  <br />
                  Phone number of customer who the template message should be
                  sent to.
                </td>
