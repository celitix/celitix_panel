...
const SendMessageNew = () => {
  ...
  const sections = [
    ...
    {id: "edit-template", title: "Edit Template"}
  ];
  ...
  return (
    ...
    >
      <div className=" p-4 lg:p-6 overflow-y-auto w-4xl mx-auto ">
        ...
        <section id="edit-template" className="mb-16">
          <div className="flex flex-col justify-center items-center gap-2 popins  ">
            <h2 className="text-xl md:text-3xl lg:text-3xl font-medium ">
              Edit TEMPLATES
            </h2>
          ...
          <div className="mt-5 flex flex-col justify-center ">
            ...
            <BaseurlComponent
              urlPrefix="Base URL"
              requestType="POST"
              param="/wrapper/waba/editTemplateById/163943810xxxxxxxe"
            />
          </div>
