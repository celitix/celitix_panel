      ...
      <div className=" p-4 lg:p-6 overflow-y-auto w-4xl mx-auto ">
        ...
        <section id="generateOtp-template" className="mb-16">
            ...
            <Table zebra bordered stickyHeader scrollButtons devVisible>
              ...
              <Table.Body>
                ...
                <Table.Row>
                  ...
                  <Table.Cell align="center">2000</Table.Cell>
                </Table.Row>
                ...
                <Table.Row>
                  ...
                  <Table.Cell align="center">DLT approved temp ID.</Table.Cell>
                </Table.Row>
              </Table.Body>
            </Table>
          </div>
          ...
          <div className="flex flex-col items-center justify-center mt-4">
            ...
            <div className="w-full">
              <RequestComponent curlBase={generateOtpTemplatecURL} />
            </div>
          </div>
        ...
        <section id="verifyOtp-template" className="mb-16">
            ...
            <Table zebra bordered stickyHeader scrollButtons devVisible>
              ...
              <Table.Body>
                ...
                <Table.Row>
                  ...
                  <Table.Cell align="center">xxxxxx (Valid OTP)</Table.Cell>
                </Table.Row>
              </Table.Body>
            </Table>
          </div>
          ...
          <div className="flex flex-col items-center justify-center mt-4">
            ...
            <div className="w-full">
              <RequestComponent curlBase={verifyOtpTemplatecURL} />
            </div>
          </div>
