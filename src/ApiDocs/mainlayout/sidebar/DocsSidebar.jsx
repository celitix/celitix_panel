                      ...
                      return (
                        <React.Fragment key={link.to}>
                          ...
                          >
                            ...
                            />
                            <span
                              className={`font-[600] ${isActive ? "text-gray-100 " : "text-gray-700"
                                }`}
                            >
                              {link.label}
                            </span>
              ...
              >
                {item.onClick ? (
                  <motion.div
                    ...
                    className={`flex items-center gap-4 px-4 py-2 transition-all w-full text-left cursor-pointer text-gray-100   hover:bg-[#585656ec] hover:text-gray-100 ${isCollapsed ? "justify-center" : ""
                      }`}
                  >
                  ...
                  <Link
                    to={item.to}
                    onClick={handleSingleRouteClick}
                    className={`flex items-center gap-0  py-2 w-full text-gray-100  hover:bg-[#585656ec] hover:text-gray-100 transition-all duration-300 ${collapsedClass} ${isActiveRoute(item.to)
                        ? "bg-[#585656ec] text-white"
                        : isDarkMode
                          ? "text-white"
                          : "text-gray-800"
