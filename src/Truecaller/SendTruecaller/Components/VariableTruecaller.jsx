...
export const VariableTruecaller = ({ setInputDetails, inputDetails, headers, inputRef }) => {
    ...
    <div className="relative">
      <div className="">
        ...
        <UniversalTextArea
          ...
          className="resize-none h-48 pr-7 scroll-ml-0.5 overflow-y-auto scrollbar-left"
          value={inputDetails}
          onChange={(e) => {
