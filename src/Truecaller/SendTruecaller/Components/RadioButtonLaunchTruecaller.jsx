...
export const RadioButtonLaunchTruecaller = ({
  allGroups,
  setSelectedOption,
  selectedOption,
  selectedGrp,
          ...
          inputDetails.attachmentType === "whatsapp_chat") && (
            <div className="mt-2">
              <InputField
                ...
                tooltipContent={
                  inputDetails.attachmentType === "whatsapp_chat"
                    ? "Enter a valid WhatsApp chat URL in the format: https://wa.me/<CountryCodePhoneNumber>. Example: https://wa.me/919876543210"
