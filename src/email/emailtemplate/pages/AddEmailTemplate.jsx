...
// APIS
import { addEmailTemplate, updateEmailTemplate } from "@/apis/email/Email";
...
const AddEmailTemplate = () => {
  ...
  const handleSave = async () => {
    ...
    const srNo = emailTemplate?.srNo

    let response;

    if (emailTemplate) {
      response = await updateEmailTemplate(payload, srNo)
    } else {
      response = await addEmailTemplate(payload);
    }
